        ...
        <div class="col">
            <div class="card" style="min-height: 85vh">
                <div class="card-header bg-white">
                    ...
                    <div class="col"><a class="btn btn-primary float-right btn-sm" href="{{ route('cetak.laporan', $transaksi->invoices_number) }}" target="_blank"><i class="fas fa-print"></i> Print</a>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <table width="100%" class="table table-borderless">
                                <tr>
                                    <td width="38%">Sub Total</td>
                                    <td width="2%">:</td>
                                    <td width="60%">{{$transaksi->sub_total}}</td>
                                </tr>
                                <tr>
                                    <td width="38%">Diskon</td>
                                    <td width="2%">:</td>
                                    <td width="60%">{{$transaksi->discount}}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td width="2%">:</td>
                                    <td width="60%">{{ $transaksi->customer->nama }}</td>
                                </tr>                   
                            </table>
                        </div>
                    </div>
